    ...
    setInterval(async () => {
        for (const sensor of sensores) {
            try {
                ...
                const tempBase = chanceDeErro ? sensor.limiteTemperatura + 5 : sensor.idealTemperatura;
                const vibraBase = chanceDeErro ? sensor.limiteVibracao + 2 : sensor.idealVibracao;
